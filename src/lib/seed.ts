...
const leads: Lead[] = [
  { id: "L001", name: "Nguyễn Văn An", phone: "0901 234 567", owner: "Linh", value: 12_000_000, last_touch: daysAgo(1), next_action: "Gọi tư vấn khóa nâng cao", tags: ["facebook", "chua_hoc", "mien_phi_online", "mua_lan_dau", "vang"], activities: seedActivities("L001", 1), area: "Quận 1, TP.HCM", segment: "gia_dinh" },
  { id: "L002", name: "Trần Thị Bình", phone: "0912 345 678", owner: "Minh", value: 25_500_000, last_touch: daysAgo(10), next_action: "Chốt hợp đồng PCTH", tags: ["tiktok", "da_hoc", "pcth", "mua_lai", "vang"], activities: seedActivities("L002", 10), area: "Quận 3, TP.HCM", segment: "co_quan" },
  { id: "L003", name: "Lê Minh Châu", phone: "0987 654 321", owner: "Linh", value: 3_200_000, last_touch: daysAgo(3), next_action: "Gửi tài liệu free", tags: ["website", "chua_hoc", "mien_phi_offline", "khong_mua", "bac"], activities: seedActivities("L003", 3), area: "Quận Bình Thạnh, TP.HCM", segment: "chuan_bi_mo" },
  { id: "L004", name: "Phạm Quốc Dũng", phone: "0978 111 222", owner: "Hà", value: 48_000_000, last_touch: daysAgo(0), next_action: "Ký nhượng quyền khu vực", tags: ["zalo", "da_hoc", "nhuong_quyen", "mua_lan_dau", "vang"], activities: seedActivities("L004", 0), orgId: "O001", area: "Quận 1, TP.HCM", segment: "co_quan" },
  { id: "L005", name: "Hoàng Thu Em", phone: "0934 567 890", owner: "Minh", value: 1_500_000, last_touch: daysAgo(14), next_action: "Follow-up sau 2 tuần", tags: ["facebook", "chua_hoc", "mien_phi_online", "ngung_mua", "dong"], activities: seedActivities("L005", 14), area: "Hà Nội", segment: "gia_dinh" },
  { id: "L006", name: "Vũ Hồng Phúc", phone: "0966 222 333", owner: "Hà", value: 8_900_000, last_touch: daysAgo(5), next_action: "Demo lớp van_hanh", tags: ["tiktok", "da_hoc", "van_hanh", "mua_lai", "bac"], activities: seedActivities("L006", 5), area: "Đà Nẵng", segment: "chuan_bi_mo" },
  { id: "L007", name: "Đỗ Thanh Giang", phone: "0945 678 901", owner: "Linh", value: 15_000_000, last_touch: daysAgo(2), next_action: "Tư vấn MKT package", tags: ["website", "chua_hoc", "mkt", "mua_lan_dau", "vang"], activities: seedActivities("L007", 2), area: "Quận 7, TP.HCM", segment: "chuan_bi_mo" },
  ...
  { id: "L009", name: "Mai Thu Hương", phone: "0922 555 666", owner: "Hà", value: 32_000_000, last_touch: daysAgo(4), next_action: "Lên kế hoạch nhượng quyền", tags: ["facebook", "da_hoc", "nhuong_quyen", "mua_lai", "vang"], activities: seedActivities("L009", 4), orgId: "O002", area: "Quận 10, TP.HCM", segment: "co_quan" },
  ...
  { id: "L012", name: "Tô Quang Long", phone: "0909 121 212", owner: "Hà", value: 19_800_000, last_touch: daysAgo(1), next_action: "Ký hợp đồng PCTH", tags: ["website", "da_hoc", "pcth", "mua_lai", "vang"], activities: seedActivities("L012", 1), orgId: "O003", area: "Quận 5, TP.HCM", segment: "co_quan" },
  ...
  { id: "L018", name: "Hà Bảo Trân", phone: "0906 555 015", owner: "Hà", value: 22_000_000, last_touch: daysAgo(3), next_action: "Chốt franchise quận 7", tags: ["zalo", "da_hoc", "nhuong_quyen", "mua_lan_dau", "vang"], activities: seedActivities("L018", 3), orgId: "O004", area: "Quận 7, TP.HCM", segment: "co_quan" },
